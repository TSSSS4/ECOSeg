...
class ECOSegConfig:
    ...
    model = 'resnet50'
    if model == 'resnet50':
        backbone_ck_path = '/home/cxq/study/objectTracking/model/MaskRCNN/backbone_res50.pkl'
        roi_heads_ck_path = '/home/cxq/study/objectTracking/model/MaskRCNN/roi_heads_res50.pkl'
        total_stride = 16
        num_dims = [64, 1024]
        feature_idx = [0, 1]
        mask_feature_idx = [1]
    elif model == 'fpn':
        backbone_ck_path = '/home/cxq/study/objectTracking/model/MaskRCNN/backbone_fpn.pkl'
        roi_heads_ck_path = '/home/cxq/study/objectTracking/model/MaskRCNN/roi_heads_fpn.pkl'
        total_stride = 32
        num_dims = [256, 256]
        feature_idx = [0, 3]
        mask_feature_idx = [0, 1, 2, 3]
